...
namespace ThuPointOfSaleFinal.App.Models
{
    public class MyDbContext : IdentityDbContext<AppUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<IdentityRole>().HasData(new IdentityRole { Id = "540fa4db-060f-4f1b-b60a-dd199bfe4f0b", Name = "AdminRole", NormalizedName = "ADMINROLE" }, new IdentityRole { Id = "540fa4db-060f-4f1b-b60a-dd199bfe4111", Name = "UserRole", NormalizedName = "USERROLE" });
